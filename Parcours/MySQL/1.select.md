...
Trouve la syntaxe pour effectuer chacune des requêtes suivantes (lis bien la formulation, chaque mot à son importance!). Vérifie 
...
1. *uniquement la température maximale prévue ("Demain le maxima observé en Belgique sera de ... degrés")*
1. *uniquement la température minimale prévue ("Demain le minima observé en Belgique sera de ... degrés")*
1. *La ou les villes dont la température minimale sera inférieure ou égale à 15 degrés*
1. *La ou les villes dont la température sera égale à 15 degrés*
1. *La ou les villes dont la température ne sera PAS égale à 15 degrés*
...
#### Drill 2
Rends-toi sur le second [bac à sable d'apprentissage](http://sqlfiddle.com/#!9/4d033a/1/0). 
...
#### Drill 3
1. *Affiche le prénom et nom de tous les octocats, par ordre alphabétique ascendant.*
1. *Affiche le prénom et nom de tous les octocats, par ordre alphabétique descendant.*
...
```sql
SELECT CONCAT('ville', ': ', bas, '/', haut ) FROM météo;
```
...
1. *Trouve la fonction permettant de n'afficher que l'année de la colonne "birthdate" et affiche le prénom de tous les octocts et leur année de naissance.  (indice: comment dit-on "année" en anglais?)*
